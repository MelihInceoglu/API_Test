...
public class C10_Post_JsonPathIleBodyTesti {
    ...
    public void jsonPath() {
        ...
        response.then().assertThat()
                ...
                .body("booking.firstname", equalTo("Ahmet"), "booking.lastname", equalTo("Bulut"), "booking.totalprice", equalTo(500),
                        "depositpaid", equalTo(false), "booking.bookingdates.checkin", equalTo("2021-06-01"),
